...
ARG LIVE_QBO_CLIENT_ID
ARG LIVE_QBO_CLIENT_SECRET
ARG LIVE_QBO_ENVIRONMENT
ARG LIVE_QBO_QUICKBOOK_URL
...
ENV LIVE_QBO_CLIENT_ID ${LIVE_QBO_CLIENT_ID}
ENV LIVE_QBO_CLIENT_SECRET ${LIVE_QBO_CLIENT_SECRET}
ENV LIVE_QBO_ENVIRONMENT ${LIVE_QBO_ENVIRONMENT}
ENV LIVE_QBO_QUICKBOOK_URL ${LIVE_QBO_QUICKBOOK_URL}
