...
from .constants import word_regexes


def get_words(filename, lang, encode):
...
def count_words(src_filename, lang, encode="utf-8", out_filename="word_count.json"):
    words = get_words(src_filename, lang, encode)
