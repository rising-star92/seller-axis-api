...
class Organization(SoftDeleteModel):
    ...
    live_realm_id = models.CharField(blank=True, null=True, max_length=255)
    live_qbo_access_token = models.TextField(blank=True, null=True)
    live_qbo_refresh_token = models.TextField(blank=True, null=True)
    live_qbo_access_token_exp_time = models.DateTimeField(null=True)
    live_qbo_refresh_token_exp_time = models.DateTimeField(null=True)
