# Generated by Django 3.2.14 on 2023-08-28 04:38

from django.db import migrations
from selleraxis.retailer_commercehub_sftp.models import RetailerCommercehubSFTP


def set_default_confim(apps, schema_editor):
    confirm_xml_format = """<?xml version="1.0" encoding="UTF-8" standalone="no"?>
...
"""
    RetailerCommercehubSFTP.objects.all().update(confirm_xml_format=confirm_xml_format)


class Migration(migrations.Migration):
    dependencies = [
        ("retailer_commercehub_sftp", "0007_apply_xsd_dynamic_at_comfirm"),
    ]

    operations = [migrations.RunPython(set_default_confim)]
