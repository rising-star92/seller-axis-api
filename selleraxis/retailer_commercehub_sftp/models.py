...
class RetailerCommercehubSFTP(models.Model):
    ...
    confirm_xml_format = models.CharField(max_length=225, blank=True, default="")
    inventory_xml_format = models.CharField(max_length=225, blank=True, default="")
    invoice_xml_format = models.CharField(max_length=225, blank=True, default="")
    return_xml_format = models.CharField(max_length=225, blank=True, default="")
    payment_xml_format = models.CharField(max_length=225, blank=True, default="")
